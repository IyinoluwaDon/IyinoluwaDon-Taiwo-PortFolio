...
const SKILLS = [
  ...
  { label: 'ML & AI',           items: ['scikit-learn', 'XGBoost', 'TensorFlow', 'NLTK', 'Transformers', 'GridSearchCV'] },
...
const PROJECTS = [
  ...
  },
  {
    ...
    github: 'https://github.com/IyinoluwaDon/Shebamiles',
    demo: null,
  },
  {
...
const EXPERIENCE = [
  ...
  },
  {
    ...
    desc: 'Advanced through the SIWES placement pipeline at ipNX, a leading Nigerian ISP. Passed the HR stage and progressed through structured technical evaluation rounds.',
  },
  {
    period: '2025',
    role: 'Data Science Researcher',
    org: 'WQU DS Labs / DSA Summer School',
    desc: 'Completed entry notebook covering Uganda CPI analysis, NLP tasks, and Gaussian ML visualisation. Applied to Deep Learning Indaba 2026 and AWS AI & ML Scholars Program.',
  },
  {
    period: '2024 — Present',
    role: 'Male Representative',
    org: 'McPherson Chorale',
    desc: 'Serve as Male Rep in the university choir. Active keyboardist in gospel and contemporary worship — chord extensions, voice layering, praise progressions.',
  },
]
    ...
    <section style={{
      ...
      <div style={{ maxWidth: 760 }}>
        ...
        <h1 style={{
          ...
          ML Engineer building<br />
          <span style={{ color: 'var(--blue)' }}>NLP &amp; Vision</span> systems.
        </h1>
        ...
        <p style={{
          ...
          300-Level Computer Science student at McPherson University with a 4.55 CGPA.
          I train models, deploy cloud pipelines, and lead PyClub McPherson — a student AI programming community.
        </p>
        ...
        <div className={`fade-up ${vis ? 'in' : ''}`} style={{
          ...
          <div>
            ...
            <h2 style={{ fontSize: 'clamp(22px,3vw,30px)', fontWeight: 300, letterSpacing: '-0.02em', lineHeight: 1.35, marginBottom: 24, color: 'var(--text)' }}>
              Student, builder,<br />community leader.
            </h2>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              {[
                "I'm a Computer Science student focused on Machine Learning Engineering, with depth in NLP and Computer Vision. I work across the full ML stack — data, modelling, evaluation, and cloud deployment.",
                "I founded PyClub McPherson to grow the next generation of ML engineers at my university, mentoring students and running workshops on Python and AI fundamentals.",
                "First Class Standing, 4.55 CGPA. Expected graduation July 2027.",
              ].map((t, i) => (
          ...
          {/* Stats */}
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1, background: 'var(--border)', border: '1px solid var(--border)', borderRadius: 8, overflow: 'hidden', alignSelf: 'start' }}>
            {[
              { n: '4.55', l: 'CGPA' },
              { n: '300L', l: 'Computer Science' },
              { n: '5+', l: 'Projects shipped' },
              { n: '2027', l: 'Expected graduation' },
            ].map(({ n, l }) => (
              <div key={l} style={{ background: 'var(--bg-card)', padding: '28px 24px' }}>
                <p style={{ fontSize: 26, fontWeight: 300, letterSpacing: '-0.03em', color: 'var(--text)', marginBottom: 4 }}>{n}</p>
